...
- Improvement - Using wp remote post method to access mailing API


= 2.3 =
- Tested up to WordPress 5.0.2
- Bug Fix - Settings not getting saved for wheel slices
- Improvement - Improve Settings API
- New Feature - Option to customize coupon message
