    ...
    function optinspin_add_settings_page() {
        ...
        Container::make( 'post_meta', 'Wheel Settings' )
            ...
            ->add_tab( __('Form Fields'), array(
				...
				Field::make( 'separator', 'optinspin_couponstyle', 'Coupon Style' )
                    ->set_classes( 'optinspin_separator' ),
                ...
                Field::make( 'text', 'optinspin_coupon_bar_msg'.optinspin_crb_get_i18n_suffix(), 'Coupon Message' )
                    ->set_help_text( 'user {coupon} tag to print winning coupon code' )
                    ->set_default_value('Check your email to get your winning coupon!'),
